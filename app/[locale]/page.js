...
export default function CaseStudiesPage() {
  ...
  const implementationInsights = [
    {
      title: t('caseStudiesPage.implementationInsights.insight1.title'),
      description: t('caseStudiesPage.implementationInsights.insight1.description'),
    },
    {
      title: t('caseStudiesPage.implementationInsights.insight2.title'),
      description: t('caseStudiesPage.implementationInsights.insight2.description'),
    },
    {
      title: t('caseStudiesPage.implementationInsights.insight3.title'),
      description: t('caseStudiesPage.implementationInsights.insight3.description'),
    },
    {
      title: t('caseStudiesPage.implementationInsights.insight4.title'),
      description: t('caseStudiesPage.implementationInsights.insight4.description'),
    },
    {
      title: t('caseStudiesPage.implementationInsights.insight5.title'),
      description: t('caseStudiesPage.implementationInsights.insight5.description'),
    },
  ];
      ...
      <section className="py-16 px-6 bg-zinc-50">
        <div className="container mx-auto max-w-6xl">
          <h2 className="text-2xl md:text-3xl font-bold mb-4 text-black">
            {t('caseStudiesPage.educationSector.title')}
          </h2>
          <h3 className="text-xl md:text-2xl font-semibold mb-12 text-zinc-700">
            {t('caseStudiesPage.educationSector.subtitle')}
          </h3>
          ...
          <div className="bg-white border border-zinc-100 rounded-xl p-8 shadow-md hover:shadow-lg hover:-translate-y-1 hover:scale-[1.02] transition-all duration-150 mb-8">
            <h4 className="text-2xl font-bold mb-6 text-black">
              {t('caseStudiesPage.educationSector.case1.title')}
            </h4>
            <div className="mb-6">
              <h5 className="text-lg font-semibold mb-3 text-black">{t('caseStudiesPage.educationSector.case1.challenge')}</h5>
              <p className="text-zinc-600">
                {t('caseStudiesPage.educationSector.case1.challengeText')}
              </p>
            </div>
            <div className="mb-6">
              <h5 className="text-lg font-semibold mb-3 text-black">{t('caseStudiesPage.educationSector.case1.solution')}</h5>
              <ul className="list-disc list-inside space-y-2 text-zinc-600 ml-4">
                {t('caseStudiesPage.educationSector.case1.solutionItems').map((item, idx) => (
                  <li key={idx}>{item}</li>
                ))}
              </ul>
            </div>
            <div className="mb-6">
              <h5 className="text-lg font-semibold mb-3 text-black">{t('caseStudiesPage.educationSector.case1.results')}</h5>
              <ul className="space-y-2 text-zinc-600">
                {t('caseStudiesPage.educationSector.case1.resultsItems').map((item, idx) => (
                  <li key={idx}><strong className="text-black">{item}</strong></li>
                ))}
              </ul>
            </div>
            <p className="text-zinc-700 italic">
              <strong>{t('caseStudiesPage.educationSector.case1.learn')}</strong> {t('caseStudiesPage.educationSector.case1.learnText')}
            </p>
          </div>
